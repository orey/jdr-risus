...
\begin{center}
\begin{tabular}{c l l}
\includegraphics[scale=0.08]{dice.png} & \textbf{Échec n°1} & \textbf{Échec n°2+}\\
1 & - & - \\
2 & - & Changeur \\
3 & - & Fleurs de folie \\
4 & Changeur & 4 sirènes \\
5 & Fleurs de folie & Vampire de l'IC \\
6 & 4 sirènes & Guetteur ou autre entité de l'IC \\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{c l}
\textbf{Rencontre} & \textbf{Caractéristique} \\
Changeur & \\
\end{tabular}
\end{center}
...
Le premier Transit est facile, mais les Transits subséquents sont plus difficiles et coûtent un ou plusieurs dés de Mégas de manière temporaire (au jugé du MJ). Voir ci-dessus les étiquettes pour les facteurs de difficultés (FD) et les pertes de dés.
